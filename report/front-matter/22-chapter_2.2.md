...
> - El 100% de los entrevistados realiza el registro de los signos vitales de forma manual, combinando fichas físicas de triaje con la posterior digitación en el sistema institucional, lo que genera doble registro de la información.
> - El 100% utiliza instrumentos de medición independientes (tensiómetro, termómetro, pulsoxímetro y glucómetro en casos de emergencia) para la toma de signos vitales.
> - El 100% estima que el triaje de un paciente toma entre 5 y 15 minutos, señalando que el registro de los datos es la actividad que más tiempo consume del proceso.
> - El 100% trabaja con laptops y PCs con sistema operativo Windows y utiliza Google Chrome como navegador principal, complementando su labor con Drive, Word y Excel.
> - El 100% utiliza el celular personal y aplicaciones de mensajería como canales diarios de coordinación con el equipo de trabajo.
> - El 100% ha recibido capacitación formal en escalas de triaje y aplica los protocolos establecidos por su institución.
> - El 100% manifestó que puede consultar posteriormente el progreso de los pacientes que clasificó a través del sistema institucional.
> - El 100% señala que los errores de triaje ocurren cuando hay alta demanda de pacientes, momento en el que se mezclan los roles y el detalle del registro del examen físico se sacrifica.

#### Pain Points

> - El 100% identificó el doble registro de la información (ficha física y digitación posterior) como la actividad que más tiempo consume del proceso.
> - El 100% expresó preocupación por enterarse tarde del deterioro de un paciente en sala de espera, debido a que la re-evaluación es manual y depende de que alguien note el cambio.
> - El 100% señaló que los pacientes que esperan no reciben información sobre su estado, lo que genera desconfianza y abandonos.
> - El 100% coincidió en que una plataforma debe ser rápida, segura, confiable e intuitiva para ser adoptada, y sería rechazada si resulta complicada.

#### Gains

> - El 100% considera que la captura automática de signos vitales reduciría la digitación manual y ahorraría tiempo valioso del triaje.
> - El 100% indicó que confiaría en las lecturas automáticas si son precisas y si puede visualizar en pantalla los signos vitales, antecedentes, alergias, nivel de prioridad y anamnesia del paciente.
> - El 100% valoró que la plataforma genere las alertas y los reportes del turno de manera automática, sin consolidar papel.

#### Segmento 2: Pacientes que acuden a emergencia

Este análisis consolida los hallazgos del entrevistado perteneciente a este segmento, representados mediante porcentajes, empezando por las características objetivas:

> - El 100% de los entrevistados acudió a emergencias en los últimos 12 meses (uno por accidente de motocicleta trabajando como repartidor).
> - El 100% es usuario intensivo del celular: gestiona banca, mensajería y trámites desde aplicaciones móviles a diario.
> - El 100% utiliza un dispositivo Android reciente y Google Chrome como navegador principal.
> - El 100% confirmó que el registro de admisión se realiza en papel, con solicitud repetida de los mismos datos.
> - El 100% experimentó esperas superiores a las 2 horas entre su llegada y la atención completa.
> - El 100% confirmó que el hospital no ofrece ningún canal digital para consultar el avance de su atención.
> - El 100% manifestó que usaría un portal web móvil entregado por el hospital para consultar su estado, siempre que no requiera instalar aplicaciones.

#### Pain Points

> - El 100% identificó la falta de información durante la espera como el aspecto más negativo de su experiencia: nadie informa cuánto falta ni qué viene después.
> - El 100% señaló que el llamado a voces genera riesgo de perder el turno y no permite saber con precisión cuándo será atendido.
> - El 100% manifestó que el nivel de prioridad asignado no le fue explicado, generando desconfianza sobre el orden de atención.
> - El 100% indicó que no existe comprobante digital de la atención: solo papeles que se extravían con facilidad.
> - El 100% describió ansiedad durante la espera, llegando incluso a considerar retirarse sin ser atendido.

#### Gains

> - El 100% afirmó que usaría un enlace o portal web del hospital para consultar en su celular el tiempo restante de su turno y su comprobante digital de atención.
> - El 100% coincidió en que la información más valiosa a visualizar es el tiempo restante de espera y la posición en la cola de atención.
> - El 100% señaló que el cambio más importante sería que el personal informe el estado del paciente de forma continua y accesible desde el celular.
